...
const { deletion } = require("../../../../src/components/delete/deletion")
...
describe('Delete handler', () => {
    ...
    beforeEach(() => {
        ...
        handler = deletion(s3Repository, dynamoRepository, encryptionService).handler;
    });

    it('should delete file from S3 and Dynamo if passwords match and file is encrypted', async () => {
        const event = {
    ...
    it('should delete file from S3 and Dynamo if passwords match and file is decrypted', async () => {
        const event = {
            body: JSON.stringify({uuid: "0c0fb1d1-f249-42b7-99e2-4e9dc47e6e77", filename: "newname.txt", password: 'password123'})
        };
    ...
    it('should return status code 403 if passwords dont match and file status is other than encrypted/decrypted', async () => {
        const event = {
            body: JSON.stringify({uuid: "0c0fb1d1-f249-42b7-99e2-4e9dc47e6e77", filename: "newname.txt", password: 'password123'})
        };
